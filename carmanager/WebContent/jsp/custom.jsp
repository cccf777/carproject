...
text-align: center;
 ...
 function id_chk(){
	window.open("id_dup.jsp?idbox="+document.form.idbox.value,target="_self");
}            
 function checkwrite(){
	if(document.form.idbox.value=="")
		alert("아이디를 입력하시오");
	if(document.form.pass.value!=""&&document.form.passh.value!="")
		if(document.form.passh.value!=document.form.pass.value){
			alert("비밀번호 불이치!");
		}
...
<body>
<form name="form1" method="post" action="good.jsp">
 <table border="1" >
	<tr><!-- 첫번째 줄 시작 -->
	    <td id="cc">아이디</td>
